...
<body>
<?php
	//Definiendo los valores a utilizar para los calculos
	define("SALTO", "\n");
	$cad = "10 metros";
	$str = "3D";
	$val = 20.5;
	...
	$concat = $str + $num;
	echo '<article>';
	echo '<p>El valor de $concat = $str + $num es: <span> = "' . $srt . '" + '. $num . '</span> = <span>';
	echo $concat . '</span> y el tipo de dato es: <span>' . gettype($concat) . "</span></p>" . SALTO;
	echo '</article>';
	echo "\n";
	...
	$concat = $str + $val;
	echo '<article>';
	echo '<p>El valor de $concat = $str + $val es: <span> = "' . $srt . '" + '. $val . '</span> = <span>';
	echo $concat . '</span> y el tipo de dato es: <span>' . gettype($concat) . "</span></p>" . SALTO;
	echo '</article>';
	echo "\n";
